function [PSNR_DCT_ifdma1 PSNR_DCT_lfdma1 y1_ifdma_DCT1 y1_lfdma_DCT1] = DCT_SCFDMA_wo(SP)
...
PSNR_DCT_ifdma1(sss)=10*log(1/MSE1_ifdma)/log(10);
figure (213)
imshow(y1_lfdma)
MSE1_lfdma=sum(sum((double(im)/255-y1_lfdma).^2))/prod(size(im));
PSNR_DCT_lfdma1(sss)=10*log(1/MSE1_lfdma)/log(10);
y1_ifdma_DCT1(:,:,sss)=y1_ifdma;
y1_lfdma_DCT1(:,:,sss)=y1_lfdma;
toc
end