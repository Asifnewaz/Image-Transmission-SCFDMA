function [PSNR_DFT_ifdma1 PSNR_DFT_lfdma1 y1_ifdma_DFT1 y1_lfdma_DFT1] = DFT_SCFDMA_wo(SP)
...
PSNR_DFT_ifdma1(sss)=10*log(1/MSE1_ifdma)/log(10);
figure (113)
imshow(y1_lfdma)
MSE1_lfdma=sum(sum((double(im)/255-y1_lfdma).^2))/prod(size(im));
PSNR_DFT_lfdma1(sss)=10*log(1/MSE1_lfdma)/log(10);
y1_ifdma_DFT1(:,:,sss)=y1_ifdma;
y1_lfdma_DFT1(:,:,sss)=y1_lfdma;
