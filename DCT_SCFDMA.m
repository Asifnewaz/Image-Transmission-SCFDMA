function [PSNR_DCT_ifdma PSNR_DCT_lfdma y1_ifdma_DCT y1_lfdma_DCT] = DCT_SCFDMA(SP)
...
PSNR_DCT_ifdma(sss)=10*log(1/MSE1_ifdma)/log(10);
figure (23)
imshow(y1_lfdma)
MSE1_lfdma=sum(sum((double(im)/255-y1_lfdma).^2))/prod(size(im));
PSNR_DCT_lfdma(sss)=10*log(1/MSE1_lfdma)/log(10);
y1_ifdma_DCT(:,:,sss)=y1_ifdma;
y1_lfdma_DCT(:,:,sss)=y1_lfdma;
toc
end